...
// Firebase configuration (env first, with safe fallbacks to avoid runtime crashes)
// Note: Firebase Web API keys are not secrets; security relies on Firebase rules.
